...
namespace CourseLibrary.API.Repos
{
    public class CourseLibraryRepository : ICourseLibraryRepository, IDisposable
    {
        ...
        public PagedList<Author> GetAuthors(AuthorsResourceParameters parameters)
        {
            ...
            string mainCategory = parameters.MainCategory?.Trim();
            ...
            var propertyMapper = _propertyMappingService.GetPropertyMapping<AuthorDto, Author>();
            collection = collection.ApplySort(parameters.OrderBy, propertyMapper);
